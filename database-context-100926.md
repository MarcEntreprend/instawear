...
| cart_items | reminded_at | timestamp with time zone | YES | null |
...
| customers | terms_accepted_at | timestamp with time zone | YES | null |
| edge_errors | id | uuid | NO | gen_random_uuid() |
| edge_errors | function_name | text | NO | null |
| edge_errors | action | text | NO | ''::text |
| edge_errors | severity | text | NO | 'medium'::text |
| edge_errors | message | text | NO | ''::text |
| edge_errors | meta | jsonb | NO | '{}'::jsonb |
| edge_errors | resolved | boolean | NO | false |
| edge_errors | created_at | timestamp with time zone | NO | now() |
...
| email_preference_events | id | uuid | NO | gen_random_uuid() |
| email_preference_events | email | text | NO | null |
| email_preference_events | changes | jsonb | NO | '{}'::jsonb |
| email_preference_events | source | text | NO | 'unsubscribe_page'::text |
| email_preference_events | ip | text | YES | null |
| email_preference_events | created_at | timestamp with time zone | NO | now() |
...
| engagement_events | id | uuid | NO | gen_random_uuid() |
| engagement_events | session_id | text | NO | null |
| engagement_events | customer_id | text | YES | null |
| engagement_events | event_type | text | NO | null |
| engagement_events | entity_type | text | NO | null |
| engagement_events | entity_id | text | NO | null |
| engagement_events | context | jsonb | NO | '{}'::jsonb |
| engagement_events | created_at | timestamp with time zone | YES | now() |
| event_dates | event_type | text | NO | null |
| event_dates | event_date | date | YES | null |
| event_dates | label | text | YES | null |
...
| merch_config | section | text | NO | null |
| merch_config | enabled | boolean | NO | true |
| merch_config | pins | ARRAY | NO | '{}'::text[] |
| merch_config | excludes | ARRAY | NO | '{}'::text[] |
| merch_config | weights | jsonb | NO | '{}'::jsonb |
| merch_config | updated_at | timestamp with time zone | YES | now() |
| merch_config | settings | jsonb | NO | '{}'::jsonb |
| merch_excluded_users | id | uuid | NO | gen_random_uuid() |
| merch_excluded_users | email | text | NO | null |
| merch_excluded_users | note | text | YES | null |
| merch_excluded_users | created_at | timestamp with time zone | YES | now() |
| merch_runs | id | uuid | NO | gen_random_uuid() |
| merch_runs | started_at | timestamp with time zone | YES | now() |
| merch_runs | finished_at | timestamp with time zone | YES | null |
| merch_runs | status | text | NO | 'running'::text |
| merch_runs | stats | jsonb | NO | '{}'::jsonb |
| mockup_jobs | id | uuid | NO | gen_random_uuid() |
| mockup_jobs | product_id | text | NO | null |
| mockup_jobs | status | text | NO | 'queued'::text |
| mockup_jobs | task_key | text | YES | null |
| mockup_jobs | options | jsonb | NO | '{}'::jsonb |
| mockup_jobs | attempts | integer | NO | 0 |
| mockup_jobs | result | jsonb | YES | null |
| mockup_jobs | created_at | timestamp with time zone | NO | now() |
| mockup_jobs | updated_at | timestamp with time zone | NO | now() |
...
| order_items | print_status | text | YES | null |
| order_items | block_reason | text | YES | null |
| order_status_transitions | from_status | text | NO | null |
| order_status_transitions | to_status | text | NO | null |
...
| orders | approval_data | jsonb | YES | null |
| orders | shipping_method_name | text | YES | null |
| orders | shipping_delivery_estimate | text | YES | null |
| orders | printful_costs | jsonb | YES | null |
...
| printful_report_snapshots | id | uuid | NO | gen_random_uuid() |
| printful_report_snapshots | period_start | date | NO | null |
| printful_report_snapshots | period_end | date | NO | null |
| printful_report_snapshots | currency | text | NO | 'USD'::text |
| printful_report_snapshots | payload | jsonb | NO | '{}'::jsonb |
| printful_report_snapshots | fetched_at | timestamp with time zone | NO | now() |
...
| product_reviews | title | text | YES | null |
| product_reviews | body | text | YES | null |
| product_reviews | helpful | integer | NO | 0 |
| product_reviews | verified | boolean | NO | false |
| product_reviews | updated_at | timestamp with time zone | YES | now() |
...
| product_scores | section | text | NO | null |
| product_scores | product_id | text | NO | null |
| product_scores | score | numeric | NO | 0 |
| product_scores | computed_at | timestamp with time zone | YES | now() |
...
| products | variant_availability | jsonb | YES | null |
...
| review_helpful | review_id | uuid | NO | null |
| review_helpful | customer_id | text | NO | null |
| review_helpful | created_at | timestamp with time zone | YES | now() |
| search_trends | term | text | NO | null |
| search_trends | hits | integer | NO | 0 |
| search_trends | updated_at | timestamp with time zone | YES | now() |
...
| edge_errors | 2200_19693_1_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_2_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_3_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_4_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_5_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_6_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_7_not_null | CHECK | null | null | null |
| edge_errors | 2200_19693_8_not_null | CHECK | null | null | null |
| edge_errors | edge_errors_pkey | PRIMARY KEY | id | edge_errors | id |
| edge_errors | edge_errors_severity_check | CHECK | null | edge_errors | severity |
...
| email_preference_events | 2200_19779_1_not_null | CHECK | null | null | null |
| email_preference_events | 2200_19779_2_not_null | CHECK | null | null | null |
| email_preference_events | 2200_19779_3_not_null | CHECK | null | null | null |
| email_preference_events | 2200_19779_4_not_null | CHECK | null | null | null |
| email_preference_events | 2200_19779_6_not_null | CHECK | null | null | null |
| email_preference_events | email_preference_events_pkey | PRIMARY KEY | id | email_preference_events | id |
...
| engagement_events | 2200_19535_1_not_null | CHECK | null | null | null |
| engagement_events | 2200_19535_2_not_null | CHECK | null | null | null |
| engagement_events | 2200_19535_4_not_null | CHECK | null | null | null |
| engagement_events | 2200_19535_5_not_null | CHECK | null | null | null |
| engagement_events | 2200_19535_6_not_null | CHECK | null | null | null |
| engagement_events | 2200_19535_7_not_null | CHECK | null | null | null |
| engagement_events | engagement_events_event_type_check | CHECK | null | engagement_events | event_type |
| engagement_events | engagement_events_pkey | PRIMARY KEY | id | engagement_events | id |
| event_dates | 2200_19590_1_not_null | CHECK | null | null | null |
| event_dates | event_dates_pkey | PRIMARY KEY | event_type | event_dates | event_type |
...
| merch_config | 2200_19520_1_not_null | CHECK | null | null | null |
| merch_config | 2200_19520_2_not_null | CHECK | null | null | null |
| merch_config | 2200_19520_3_not_null | CHECK | null | null | null |
| merch_config | 2200_19520_4_not_null | CHECK | null | null | null |
| merch_config | 2200_19520_5_not_null | CHECK | null | null | null |
| merch_config | 2200_19520_7_not_null | CHECK | null | null | null |
| merch_config | merch_config_pkey | PRIMARY KEY | section | merch_config | section |
| merch_excluded_users | 2200_19604_1_not_null | CHECK | null | null | null |
| merch_excluded_users | 2200_19604_2_not_null | CHECK | null | null | null |
| merch_excluded_users | merch_excluded_users_email_key | UNIQUE | email | merch_excluded_users | email |
| merch_excluded_users | merch_excluded_users_pkey | PRIMARY KEY | id | merch_excluded_users | id |
| merch_runs | 2200_19562_1_not_null | CHECK | null | null | null |
| merch_runs | 2200_19562_4_not_null | CHECK | null | null | null |
| merch_runs | 2200_19562_5_not_null | CHECK | null | null | null |
| merch_runs | merch_runs_pkey | PRIMARY KEY | id | merch_runs | id |
| mockup_jobs | 2200_19728_1_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_2_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_3_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_5_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_6_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_8_not_null | CHECK | null | null | null |
| mockup_jobs | 2200_19728_9_not_null | CHECK | null | null | null |
| mockup_jobs | mockup_jobs_pkey | PRIMARY KEY | id | mockup_jobs | id |
| mockup_jobs | mockup_jobs_product_id_fkey | FOREIGN KEY | product_id | products | id |
| mockup_jobs | mockup_jobs_status_check | CHECK | null | mockup_jobs | status |
...
| order_items | order_items_print_status_check | CHECK | null | order_items | print_status |
...
| order_status_transitions | 2200_19440_1_not_null | CHECK | null | null | null |
| order_status_transitions | 2200_19440_2_not_null | CHECK | null | null | null |
| order_status_transitions | order_status_transitions_pkey | PRIMARY KEY | from_status | order_status_transitions | from_status |
| order_status_transitions | order_status_transitions_pkey | PRIMARY KEY | to_status | order_status_transitions | to_status |
| order_status_transitions | order_status_transitions_pkey | PRIMARY KEY | to_status | order_status_transitions | from_status |
| order_status_transitions | order_status_transitions_pkey | PRIMARY KEY | from_status | order_status_transitions | to_status |
...
| printful_report_snapshots | 2200_19668_1_not_null | CHECK | null | null | null |
| printful_report_snapshots | 2200_19668_2_not_null | CHECK | null | null | null |
| printful_report_snapshots | 2200_19668_3_not_null | CHECK | null | null | null |
| printful_report_snapshots | 2200_19668_4_not_null | CHECK | null | null | null |
| printful_report_snapshots | 2200_19668_5_not_null | CHECK | null | null | null |
| printful_report_snapshots | 2200_19668_6_not_null | CHECK | null | null | null |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | currency | printful_report_snapshots | period_end |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_end | printful_report_snapshots | currency |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_start | printful_report_snapshots | period_start |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_start | printful_report_snapshots | period_end |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_start | printful_report_snapshots | currency |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_end | printful_report_snapshots | period_end |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | period_end | printful_report_snapshots | period_start |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | currency | printful_report_snapshots | currency |
| printful_report_snapshots | printful_report_snapshots_period_start_period_end_currency_key | UNIQUE | currency | printful_report_snapshots | period_start |
| printful_report_snapshots | printful_report_snapshots_pkey | PRIMARY KEY | id | printful_report_snapshots | id |
...
| product_reviews | 2200_19126_10_not_null | CHECK | null | null | null |
| product_reviews | 2200_19126_11_not_null | CHECK | null | null | null |
...
| product_scores | 2200_19551_1_not_null | CHECK | null | null | null |
| product_scores | 2200_19551_2_not_null | CHECK | null | null | null |
| product_scores | 2200_19551_3_not_null | CHECK | null | null | null |
| product_scores | product_scores_pkey | PRIMARY KEY | section | product_scores | section |
| product_scores | product_scores_pkey | PRIMARY KEY | section | product_scores | product_id |
| product_scores | product_scores_pkey | PRIMARY KEY | product_id | product_scores | section |
| product_scores | product_scores_pkey | PRIMARY KEY | product_id | product_scores | product_id |
...
| review_helpful | 2200_19474_1_not_null | CHECK | null | null | null |
| review_helpful | 2200_19474_2_not_null | CHECK | null | null | null |
| review_helpful | review_helpful_pkey | PRIMARY KEY | review_id | review_helpful | review_id |
| review_helpful | review_helpful_pkey | PRIMARY KEY | customer_id | review_helpful | review_id |
| review_helpful | review_helpful_pkey | PRIMARY KEY | customer_id | review_helpful | customer_id |
| review_helpful | review_helpful_pkey | PRIMARY KEY | review_id | review_helpful | customer_id |
| review_helpful | review_helpful_review_id_fkey | FOREIGN KEY | review_id | product_reviews | id |
| search_trends | 2200_19574_1_not_null | CHECK | null | null | null |
| search_trends | 2200_19574_2_not_null | CHECK | null | null | null |
| search_trends | search_trends_pkey | PRIMARY KEY | term | search_trends | term |
...
| interactions | true |
| merch_config | true |
| merch_excluded_users | true |
| merch_runs | true |
| mockup_jobs | true |
| newsletter_subscribers | true |
| notifications | true |
| order_items | true |
| order_status_transitions | true |
| orders | true |
| pod_settings | true |
| printful_report_snapshots | true |
...
| public | edge_errors | edge_errors_select_admin | PERMISSIVE | {public} | SELECT | is_admin() | null |
| public | edge_errors | edge_errors_update_admin | PERMISSIVE | {public} | UPDATE | is_admin() | is_admin() |
...
| public | email_preference_events | email_pref_events_admin_all | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
...
| public | engagement_events | engagement_admin_all | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
| public | engagement_events | engagement_insert_all | PERMISSIVE | {anon,authenticated} | INSERT | null | (((char_length(session_id) >= 8) AND (char_length(session_id) <= 64)) AND (char_length(entity_id) <= 200)) |
| public | event_dates | event_dates_select_public | PERMISSIVE | {anon,authenticated} | SELECT | true | null |
| public | event_dates | event_dates_write_admin | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
...
| public | interaction_messages | interaction_messages_insert_contact | PERMISSIVE | {anon} | INSERT | null | ((from_field = 'customer'::text) AND ((char_length(COALESCE(text, ''::text)) >= 10) AND (char_length(COALESCE(text, ''::text)) <= 5000)) AND (EXISTS ( SELECT 1
FROM interactions i
WHERE ((i.id = interaction_messages.interaction_id) AND (i.type = ANY (ARRAY['question'::text, 'feedback'::text])))))) |
...
| public | interactions | interactions_insert_contact | PERMISSIVE | {anon} | INSERT | null | ((type = ANY (ARRAY['question'::text, 'feedback'::text])) AND (status = 'open'::text) AND (customer_email ~ '^[^@\s]+@[^@\s]+\.[^@\s]+$'::text) AND ((char_length(COALESCE(last_message, ''::text)) >= 10) AND (char_length(COALESCE(last_message, ''::text)) <= 5000)) AND (char_length(COALESCE(subject, ''::text)) <= 200)) |
...
| public | merch_config | merch_config_select_public | PERMISSIVE | {anon,authenticated} | SELECT | true | null |
| public | merch_config | merch_config_write_admin | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
| public | merch_excluded_users | merch_excluded_admin_all | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
| public | merch_runs | merch_runs_admin_all | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
| public | mockup_jobs | mockup_jobs_admin_all | PERMISSIVE | {public} | ALL | is_admin() | is_admin() |
| public | newsletter_subscribers | newsletter_subscribers_admin_all | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
...
| public | order_status_transitions | allow read transitions | PERMISSIVE | {public} | SELECT | true | null |
...
| public | printful_report_snapshots | printful_reports_select_admin | PERMISSIVE | {public} | SELECT | is_admin() | null |
| public | printful_report_snapshots | printful_reports_write_admin | PERMISSIVE | {public} | ALL | is_admin() | is_admin() |
...
| public | product_reviews | product_reviews_delete_own | PERMISSIVE | {public} | DELETE | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | null |
| public | product_reviews | product_reviews_insert_admin | PERMISSIVE | {authenticated} | INSERT | null | is_admin() |
| public | product_reviews | product_reviews_insert_own | PERMISSIVE | {public} | INSERT | null | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
...
| public | product_reviews | product_reviews_update_own | PERMISSIVE | {public} | UPDATE | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
| public | product_scores | product_scores_select_public | PERMISSIVE | {anon,authenticated} | SELECT | true | null |
| public | product_scores | product_scores_write_admin | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
...
| public | review_helpful | review_helpful_delete_own | PERMISSIVE | {public} | DELETE | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = review_helpful.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | null |
| public | review_helpful | review_helpful_insert_own | PERMISSIVE | {public} | INSERT | null | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = review_helpful.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
| public | review_helpful | review_helpful_select_all | PERMISSIVE | {public} | SELECT | true | null |
| public | search_trends | search_trends_select_public | PERMISSIVE | {anon,authenticated} | SELECT | true | null |
| public | search_trends | search_trends_write_admin | PERMISSIVE | {authenticated} | ALL | is_admin() | is_admin() |
...
| anon | edge_errors | DELETE |
| anon | edge_errors | INSERT |
| anon | edge_errors | REFERENCES |
| anon | edge_errors | SELECT |
| anon | edge_errors | TRIGGER |
| anon | edge_errors | TRUNCATE |
| anon | edge_errors | UPDATE |
...
| anon | email_preference_events | DELETE |
| anon | email_preference_events | INSERT |
| anon | email_preference_events | REFERENCES |
| anon | email_preference_events | SELECT |
| anon | email_preference_events | TRIGGER |
| anon | email_preference_events | TRUNCATE |
| anon | email_preference_events | UPDATE |
...
| anon | engagement_events | DELETE |
| anon | engagement_events | INSERT |
| anon | engagement_events | REFERENCES |
| anon | engagement_events | SELECT |
| anon | engagement_events | TRIGGER |
| anon | engagement_events | TRUNCATE |
| anon | engagement_events | UPDATE |
| anon | event_dates | DELETE |
| anon | event_dates | INSERT |
| anon | event_dates | REFERENCES |
| anon | event_dates | SELECT |
| anon | event_dates | TRIGGER |
| anon | event_dates | TRUNCATE |
| anon | event_dates | UPDATE |
...
| anon | merch_config | DELETE |
| anon | merch_config | INSERT |
| anon | merch_config | REFERENCES |
| anon | merch_config | SELECT |
| anon | merch_config | TRIGGER |
| anon | merch_config | TRUNCATE |
| anon | merch_config | UPDATE |
| anon | merch_excluded_users | DELETE |
| anon | merch_excluded_users | INSERT |
| anon | merch_excluded_users | REFERENCES |
| anon | merch_excluded_users | SELECT |
| anon | merch_excluded_users | TRIGGER |
| anon | merch_excluded_users | TRUNCATE |
| anon | merch_excluded_users | UPDATE |
| anon | merch_runs | DELETE |
| anon | merch_runs | INSERT |
| anon | merch_runs | REFERENCES |
| anon | merch_runs | SELECT |
| anon | merch_runs | TRIGGER |
| anon | merch_runs | TRUNCATE |
| anon | merch_runs | UPDATE |
| anon | mockup_jobs | DELETE |
| anon | mockup_jobs | INSERT |
| anon | mockup_jobs | REFERENCES |
| anon | mockup_jobs | SELECT |
| anon | mockup_jobs | TRIGGER |
| anon | mockup_jobs | TRUNCATE |
| anon | mockup_jobs | UPDATE |
...
| anon | order_status_transitions | DELETE |
| anon | order_status_transitions | INSERT |
| anon | order_status_transitions | REFERENCES |
| anon | order_status_transitions | SELECT |
| anon | order_status_transitions | TRIGGER |
| anon | order_status_transitions | TRUNCATE |
| anon | order_status_transitions | UPDATE |
| anon | orders | DELETE |
| anon | orders | INSERT |
| anon | orders | SELECT |
| anon | orders | UPDATE |
...
| anon | printful_report_snapshots | DELETE |
| anon | printful_report_snapshots | INSERT |
| anon | printful_report_snapshots | REFERENCES |
| anon | printful_report_snapshots | SELECT |
| anon | printful_report_snapshots | TRIGGER |
| anon | printful_report_snapshots | TRUNCATE |
| anon | printful_report_snapshots | UPDATE |
...
| anon | product_scores | DELETE |
| anon | product_scores | INSERT |
| anon | product_scores | REFERENCES |
| anon | product_scores | SELECT |
| anon | product_scores | TRIGGER |
| anon | product_scores | TRUNCATE |
| anon | product_scores | UPDATE |
...
| anon | review_helpful | DELETE |
| anon | review_helpful | INSERT |
| anon | review_helpful | REFERENCES |
| anon | review_helpful | SELECT |
| anon | review_helpful | TRIGGER |
| anon | review_helpful | TRUNCATE |
| anon | review_helpful | UPDATE |
| anon | search_trends | DELETE |
| anon | search_trends | INSERT |
| anon | search_trends | REFERENCES |
| anon | search_trends | SELECT |
| anon | search_trends | TRIGGER |
| anon | search_trends | TRUNCATE |
| anon | search_trends | UPDATE |
...
| authenticated | edge_errors | DELETE |
| authenticated | edge_errors | INSERT |
| authenticated | edge_errors | REFERENCES |
| authenticated | edge_errors | SELECT |
| authenticated | edge_errors | TRIGGER |
| authenticated | edge_errors | TRUNCATE |
| authenticated | edge_errors | UPDATE |
...
| authenticated | email_preference_events | DELETE |
| authenticated | email_preference_events | INSERT |
| authenticated | email_preference_events | REFERENCES |
| authenticated | email_preference_events | SELECT |
| authenticated | email_preference_events | TRIGGER |
| authenticated | email_preference_events | TRUNCATE |
| authenticated | email_preference_events | UPDATE |
...
| authenticated | engagement_events | DELETE |
| authenticated | engagement_events | INSERT |
| authenticated | engagement_events | REFERENCES |
| authenticated | engagement_events | SELECT |
| authenticated | engagement_events | TRIGGER |
| authenticated | engagement_events | TRUNCATE |
| authenticated | engagement_events | UPDATE |
| authenticated | event_dates | DELETE |
| authenticated | event_dates | INSERT |
| authenticated | event_dates | REFERENCES |
| authenticated | event_dates | SELECT |
| authenticated | event_dates | TRIGGER |
| authenticated | event_dates | TRUNCATE |
| authenticated | event_dates | UPDATE |
...
| authenticated | merch_config | DELETE |
| authenticated | merch_config | INSERT |
| authenticated | merch_config | REFERENCES |
| authenticated | merch_config | SELECT |
| authenticated | merch_config | TRIGGER |
| authenticated | merch_config | TRUNCATE |
| authenticated | merch_config | UPDATE |
| authenticated | merch_excluded_users | DELETE |
| authenticated | merch_excluded_users | INSERT |
| authenticated | merch_excluded_users | REFERENCES |
| authenticated | merch_excluded_users | SELECT |
| authenticated | merch_excluded_users | TRIGGER |
| authenticated | merch_excluded_users | TRUNCATE |
| authenticated | merch_excluded_users | UPDATE |
| authenticated | merch_runs | DELETE |
| authenticated | merch_runs | INSERT |
| authenticated | merch_runs | REFERENCES |
| authenticated | merch_runs | SELECT |
| authenticated | merch_runs | TRIGGER |
| authenticated | merch_runs | TRUNCATE |
| authenticated | merch_runs | UPDATE |
| authenticated | mockup_jobs | DELETE |
| authenticated | mockup_jobs | INSERT |
| authenticated | mockup_jobs | REFERENCES |
| authenticated | mockup_jobs | SELECT |
| authenticated | mockup_jobs | TRIGGER |
| authenticated | mockup_jobs | TRUNCATE |
| authenticated | mockup_jobs | UPDATE |
...
| authenticated | order_status_transitions | DELETE |
| authenticated | order_status_transitions | INSERT |
| authenticated | order_status_transitions | REFERENCES |
| authenticated | order_status_transitions | SELECT |
| authenticated | order_status_transitions | TRIGGER |
| authenticated | order_status_transitions | TRUNCATE |
| authenticated | order_status_transitions | UPDATE |
...
| authenticated | printful_report_snapshots | DELETE |
| authenticated | printful_report_snapshots | INSERT |
| authenticated | printful_report_snapshots | REFERENCES |
| authenticated | printful_report_snapshots | SELECT |
| authenticated | printful_report_snapshots | TRIGGER |
| authenticated | printful_report_snapshots | TRUNCATE |
| authenticated | printful_report_snapshots | UPDATE |
...
| authenticated | product_scores | DELETE |
| authenticated | product_scores | INSERT |
| authenticated | product_scores | REFERENCES |
| authenticated | product_scores | SELECT |
| authenticated | product_scores | TRIGGER |
| authenticated | product_scores | TRUNCATE |
| authenticated | product_scores | UPDATE |
...
| authenticated | review_helpful | DELETE |
| authenticated | review_helpful | INSERT |
| authenticated | review_helpful | REFERENCES |
| authenticated | review_helpful | SELECT |
| authenticated | review_helpful | TRIGGER |
| authenticated | review_helpful | TRUNCATE |
| authenticated | review_helpful | UPDATE |
| authenticated | search_trends | DELETE |
| authenticated | search_trends | INSERT |
| authenticated | search_trends | REFERENCES |
| authenticated | search_trends | SELECT |
| authenticated | search_trends | TRIGGER |
| authenticated | search_trends | TRUNCATE |
| authenticated | search_trends | UPDATE |
...
| postgres | edge_errors | DELETE |
| postgres | edge_errors | INSERT |
| postgres | edge_errors | REFERENCES |
| postgres | edge_errors | SELECT |
| postgres | edge_errors | TRIGGER |
| postgres | edge_errors | TRUNCATE |
| postgres | edge_errors | UPDATE |
...
| postgres | email_preference_events | DELETE |
| postgres | email_preference_events | INSERT |
| postgres | email_preference_events | REFERENCES |
| postgres | email_preference_events | SELECT |
| postgres | email_preference_events | TRIGGER |
| postgres | email_preference_events | TRUNCATE |
| postgres | email_preference_events | UPDATE |
...
| postgres | engagement_events | DELETE |
| postgres | engagement_events | INSERT |
| postgres | engagement_events | REFERENCES |
| postgres | engagement_events | SELECT |
| postgres | engagement_events | TRIGGER |
| postgres | engagement_events | TRUNCATE |
| postgres | engagement_events | UPDATE |
| postgres | event_dates | DELETE |
| postgres | event_dates | INSERT |
| postgres | event_dates | REFERENCES |
| postgres | event_dates | SELECT |
| postgres | event_dates | TRIGGER |
| postgres | event_dates | TRUNCATE |
| postgres | event_dates | UPDATE |
...
| postgres | merch_config | DELETE |
| postgres | merch_config | INSERT |
| postgres | merch_config | REFERENCES |
| postgres | merch_config | SELECT |
| postgres | merch_config | TRIGGER |
| postgres | merch_config | TRUNCATE |
| postgres | merch_config | UPDATE |
| postgres | merch_excluded_users | DELETE |
| postgres | merch_excluded_users | INSERT |
| postgres | merch_excluded_users | REFERENCES |
| postgres | merch_excluded_users | SELECT |
| postgres | merch_excluded_users | TRIGGER |
| postgres | merch_excluded_users | TRUNCATE |
| postgres | merch_excluded_users | UPDATE |
| postgres | merch_runs | DELETE |
| postgres | merch_runs | INSERT |
| postgres | merch_runs | REFERENCES |
| postgres | merch_runs | SELECT |
| postgres | merch_runs | TRIGGER |
| postgres | merch_runs | TRUNCATE |
| postgres | merch_runs | UPDATE |
| postgres | mockup_jobs | DELETE |
| postgres | mockup_jobs | INSERT |
| postgres | mockup_jobs | REFERENCES |
| postgres | mockup_jobs | SELECT |
| postgres | mockup_jobs | TRIGGER |
| postgres | mockup_jobs | TRUNCATE |
| postgres | mockup_jobs | UPDATE |
...
| postgres | order_status_transitions | DELETE |
| postgres | order_status_transitions | INSERT |
| postgres | order_status_transitions | REFERENCES |
| postgres | order_status_transitions | SELECT |
| postgres | order_status_transitions | TRIGGER |
| postgres | order_status_transitions | TRUNCATE |
| postgres | order_status_transitions | UPDATE |
...
| postgres | printful_report_snapshots | DELETE |
| postgres | printful_report_snapshots | INSERT |
| postgres | printful_report_snapshots | REFERENCES |
| postgres | printful_report_snapshots | SELECT |
| postgres | printful_report_snapshots | TRIGGER |
| postgres | printful_report_snapshots | TRUNCATE |
| postgres | printful_report_snapshots | UPDATE |
...
| postgres | product_scores | DELETE |
| postgres | product_scores | INSERT |
| postgres | product_scores | REFERENCES |
| postgres | product_scores | SELECT |
| postgres | product_scores | TRIGGER |
| postgres | product_scores | TRUNCATE |
| postgres | product_scores | UPDATE |
...
| postgres | review_helpful | DELETE |
| postgres | review_helpful | INSERT |
| postgres | review_helpful | REFERENCES |
| postgres | review_helpful | SELECT |
| postgres | review_helpful | TRIGGER |
| postgres | review_helpful | TRUNCATE |
| postgres | review_helpful | UPDATE |
| postgres | search_trends | DELETE |
| postgres | search_trends | INSERT |
| postgres | search_trends | REFERENCES |
| postgres | search_trends | SELECT |
| postgres | search_trends | TRIGGER |
| postgres | search_trends | TRUNCATE |
| postgres | search_trends | UPDATE |
...
| service_role | edge_errors | DELETE |
| service_role | edge_errors | INSERT |
| service_role | edge_errors | REFERENCES |
| service_role | edge_errors | SELECT |
| service_role | edge_errors | TRIGGER |
| service_role | edge_errors | TRUNCATE |
| service_role | edge_errors | UPDATE |
...
| service_role | email_preference_events | DELETE |
| service_role | email_preference_events | INSERT |
| service_role | email_preference_events | REFERENCES |
| service_role | email_preference_events | SELECT |
| service_role | email_preference_events | TRIGGER |
| service_role | email_preference_events | TRUNCATE |
| service_role | email_preference_events | UPDATE |
...
| service_role | engagement_events | DELETE |
| service_role | engagement_events | INSERT |
| service_role | engagement_events | REFERENCES |
| service_role | engagement_events | SELECT |
| service_role | engagement_events | TRIGGER |
| service_role | engagement_events | TRUNCATE |
| service_role | engagement_events | UPDATE |
| service_role | event_dates | DELETE |
| service_role | event_dates | INSERT |
| service_role | event_dates | REFERENCES |
| service_role | event_dates | SELECT |
| service_role | event_dates | TRIGGER |
| service_role | event_dates | TRUNCATE |
| service_role | event_dates | UPDATE |
...
| service_role | merch_config | DELETE |
| service_role | merch_config | INSERT |
| service_role | merch_config | REFERENCES |
| service_role | merch_config | SELECT |
| service_role | merch_config | TRIGGER |
| service_role | merch_config | TRUNCATE |
| service_role | merch_config | UPDATE |
| service_role | merch_excluded_users | DELETE |
| service_role | merch_excluded_users | INSERT |
| service_role | merch_excluded_users | REFERENCES |
| service_role | merch_excluded_users | SELECT |
| service_role | merch_excluded_users | TRIGGER |
| service_role | merch_excluded_users | TRUNCATE |
| service_role | merch_excluded_users | UPDATE |
| service_role | merch_runs | DELETE |
| service_role | merch_runs | INSERT |
| service_role | merch_runs | REFERENCES |
| service_role | merch_runs | SELECT |
| service_role | merch_runs | TRIGGER |
| service_role | merch_runs | TRUNCATE |
| service_role | merch_runs | UPDATE |
| service_role | mockup_jobs | DELETE |
| service_role | mockup_jobs | INSERT |
| service_role | mockup_jobs | REFERENCES |
| service_role | mockup_jobs | SELECT |
| service_role | mockup_jobs | TRIGGER |
| service_role | mockup_jobs | TRUNCATE |
| service_role | mockup_jobs | UPDATE |
...
| service_role | order_status_transitions | DELETE |
| service_role | order_status_transitions | INSERT |
| service_role | order_status_transitions | REFERENCES |
| service_role | order_status_transitions | SELECT |
| service_role | order_status_transitions | TRIGGER |
| service_role | order_status_transitions | TRUNCATE |
| service_role | order_status_transitions | UPDATE |
...
| service_role | printful_report_snapshots | DELETE |
| service_role | printful_report_snapshots | INSERT |
| service_role | printful_report_snapshots | REFERENCES |
| service_role | printful_report_snapshots | SELECT |
| service_role | printful_report_snapshots | TRIGGER |
| service_role | printful_report_snapshots | TRUNCATE |
| service_role | printful_report_snapshots | UPDATE |
...
| service_role | product_scores | DELETE |
| service_role | product_scores | INSERT |
| service_role | product_scores | REFERENCES |
| service_role | product_scores | SELECT |
| service_role | product_scores | TRIGGER |
| service_role | product_scores | TRUNCATE |
| service_role | product_scores | UPDATE |
...
| service_role | review_helpful | DELETE |
| service_role | review_helpful | INSERT |
| service_role | review_helpful | REFERENCES |
| service_role | review_helpful | SELECT |
| service_role | review_helpful | TRIGGER |
| service_role | review_helpful | TRUNCATE |
| service_role | review_helpful | UPDATE |
| service_role | search_trends | DELETE |
| service_role | search_trends | INSERT |
| service_role | search_trends | REFERENCES |
| service_role | search_trends | SELECT |
| service_role | search_trends | TRIGGER |
| service_role | search_trends | TRUNCATE |
| service_role | search_trends | UPDATE |
...
-- =============================================================================
| routine*name | routine_type | data_type | routine_definition |
| --------------------------- | ------------ | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| assert_order_transition | FUNCTION | boolean |
...
END;
|
| decrement_helpful | FUNCTION | void | update product_reviews set helpful = greatest(helpful - 1,0) where id = rid |
...
LIMIT 1;
|
| get_my_customer_profile | FUNCTION | record |
...
v_items jsonb;
BEGIN
IF p_code IS NULL OR p_code !~ '^[A-Za-z0-9*-]{6,64}$' THEN
RETURN NULL;
END IF;
...
END;
|
| increment_helpful | FUNCTION | void | update product_reviews set helpful = helpful + 1 where id = rid |
...
|
| is_verified_buyer | FUNCTION | boolean |
select exists (
...
|
| product_affinity | FUNCTION | record |
select oi2.product_id, count(_)::int as bought_together
...
ratings_count = (SELECT COUNT(_) FROM product_reviews WHERE product_id = NEW.product_id)
...
| product_reviews | trg_product_reviews_updated | BEFORE | UPDATE | EXECUTE FUNCTION touch_updated_at() |
...
| review_helpful | trg_helpful_after_delete | AFTER | DELETE | EXECUTE FUNCTION trg_helpful_dec() |
| review_helpful | trg_helpful_after_insert | AFTER | INSERT | EXECUTE FUNCTION trg_helpful_inc() |
...
-- 🛡️ Script 2 – Vérification rapide de l’état de sécurité
...
| edge_errors | edge_errors_select_admin | SELECT | {public} | is_admin() | true |
| edge_errors | edge_errors_update_admin | UPDATE | {public} | is_admin() | is_admin() |
...
| email_preference_events | email_pref_events_admin_all | ALL | {authenticated} | is_admin() | is_admin() |
...
| engagement_events | engagement_admin_all | ALL | {authenticated} | is_admin() | is_admin() |
| engagement_events | engagement_insert_all | INSERT | {anon,authenticated} | true | (((char_length(session_id) >= 8) AND (char_length(session_id) <= 64)) AND (char_length(entity_id) <= 200)) |
| event_dates | event_dates_write_admin | ALL | {authenticated} | is_admin() | is_admin() |
| event_dates | event_dates_select_public | SELECT | {anon,authenticated} | true | true |
...
FROM interactions i
WHERE ((i.id = interaction_messages.interaction_id) AND (i.customer_email = (auth.jwt() ->> 'email'::text)))))) |
| interaction_messages | interaction_messages_insert_contact | INSERT | {anon} | true | ((from_field = 'customer'::text) AND ((char_length(COALESCE(text, ''::text)) >= 10) AND (char_length(COALESCE(text, ''::text)) <= 5000)) AND (EXISTS ( SELECT 1
FROM interactions i
WHERE ((i.id = interaction_messages.interaction_id) AND (i.type = ANY (ARRAY['question'::text, 'feedback'::text])))))) |
...
| interactions | interactions_insert_contact | INSERT | {anon} | true | ((type = ANY (ARRAY['question'::text, 'feedback'::text])) AND (status = 'open'::text) AND (customer_email ~ '^[^@\s]+@[^@\s]+\.[^@\s]+$'::text) AND ((char_length(COALESCE(last_message, ''::text)) >= 10) AND (char_length(COALESCE(last_message, ''::text)) <= 5000)) AND (char_length(COALESCE(subject, ''::text)) <= 200)) |
...
| merch_config | merch_config_write_admin | ALL | {authenticated} | is_admin() | is_admin() |
| merch_config | merch_config_select_public | SELECT | {anon,authenticated} | true | true |
| merch_excluded_users | merch_excluded_admin_all | ALL | {authenticated} | is_admin() | is_admin() |
| merch_runs | merch_runs_admin_all | ALL | {authenticated} | is_admin() | is_admin() |
| mockup_jobs | mockup_jobs_admin_all | ALL | {public} | is_admin() | is_admin() |
| newsletter_subscribers | newsletter_subscribers_admin_all | ALL | {authenticated} | is_admin() | is_admin() |
...
| order_status_transitions | allow read transitions | SELECT | {public} | true | true |
...
| printful_report_snapshots | printful_reports_write_admin | ALL | {public} | is_admin() | is_admin() |
| printful_report_snapshots | printful_reports_select_admin | SELECT | {public} | is_admin() | true |
...
| product_reviews | product_reviews_delete_own | DELETE | {public} | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | true |
| product_reviews | product_reviews_insert_own | INSERT | {public} | true | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
...
| product_reviews | product_reviews_update_own | UPDATE | {public} | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = product_reviews.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
| product_scores | product_scores_write_admin | ALL | {authenticated} | is_admin() | is_admin() |
| product_scores | product_scores_select_public | SELECT | {anon,authenticated} | true | true |
...
| review_helpful | review_helpful_delete_own | DELETE | {public} | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = review_helpful.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) | true |
| review_helpful | review_helpful_insert_own | INSERT | {public} | true | (is_admin() OR (customer_id = (auth.uid())::text) OR (EXISTS ( SELECT 1
FROM customers c
WHERE ((c.id = review_helpful.customer_id) AND (c.email = (auth.jwt() ->> 'email'::text)))))) |
| review_helpful | review_helpful_select_all | SELECT | {public} | true | true |
| search_trends | search_trends_write_admin | ALL | {authenticated} | is_admin() | is_admin() |
| search_trends | search_trends_select_public | SELECT | {anon,authenticated} | true | true |
...
| --------------------------- | ------------ | ------------- | ----------------- |
| assert_order_transition | FUNCTION | DEFINER | SQL |
...
| is_verified_buyer | FUNCTION | DEFINER | SQL |
| product_affinity | FUNCTION | DEFINER | SQL |
...
| orders_status_check | orders | CHECK ((status = ANY (ARRAY['pending'::text, 'paid'::text, 'in_production'::text, 'shipped'::text, 'delivered'::text, 'cancelled'::text, 'on_hold'::text, 'refunded'::text, 'returned'::text, 'partial'::text]))) |
| order_items_print_status_check | order_items | CHECK ((print_status = ANY (ARRAY['pending'::text, 'fulfillable'::text, 'blocked_inactive'::text, 'blocked_discontinued'::text, 'blocked_out_of_stock'::text, 'fulfilled'::text, 'failed'::text]))) |
...
| engagement_events_event_type_check | engagement_events | CHECK ((event_type = ANY (ARRAY['section_impression'::text, 'product_click'::text, 'search'::text, 'filter_applied'::text, 'add_to_cart'::text, 'favourite'::text]))) |
| edge_errors_severity_check | edge_errors | CHECK ((severity = ANY (ARRAY['critical'::text, 'high'::text, 'medium'::text]))) |
| mockup_jobs_status_check | mockup_jobs | CHECK ((status = ANY (ARRAY['queued'::text, 'processing'::text, 'done'::text, 'failed'::text]))) |

// NOTE
// ProductModal.tsx n'est importé ni dans App.tsx, ni dans aucun autre composant.
// Il n'apparaît pas sur le site. C'est un fichier vestige — il traîne dans le dossier components/ mais n'est jamais rendu.
// PUT IN COMMENT, JUST IN CASE
...
//   const handleBuyNow = () => {
//     onAddToCart(product, selectedColor, selectedSize);
//     // L'ouverture du checkout est gérée par le parent (App.tsx)
//     onClose();
//   };

...
<a href="${BASE_URL}?order=${encodeURIComponent(id)}" style="display:inline-block;padding:12px 24px;background:#FF5C35;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;">View order details →</a>
...
<a href="${BASE_URL}?order=${encodeURIComponent(id)}" style="display:inline-block;padding:12px 24px;background:#7c3aed;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;">View order details →</a>
${buildFooter(clientEmail)}
</div></body></html>`;
...
<a href="${BASE_URL}?order=${encodeURIComponent(id)}" style="display:inline-block;padding:12px 24px;background:#cc0000;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;">View order details →</a><br><br>
<a href="${BASE_URL}/contact" style="display:inline-block;padding:12px 24px;background:#999;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;">Contact support →</a>
${buildFooter(clientEmail)}
</div></body></html>`;

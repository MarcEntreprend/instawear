...
export const DEFAULT_PRODUCTS: Product[] = [
  {
    ...
    brand: 'INSTAWEAR',
    description: 'T-shirt premium en coton bio célébrant l\'emblématique Carnaval de Rio avec un graphisme néon vibrant.',
    fullDescription: '• Coton 100% biologique peigné (180 g/m²)\n• Impression numérique HD haute durabilité (certifiée éco-responsable)\n• Coupe unisexe moderne avec coutures latérales doublées\n• Design exclusif généré par IA représentant l\'énergie pure de la samba en éclairs néons',
    price: 29.99,
    originalPrice: 45.00,
    ...
    colorNames: ['Cyan Électrique', 'Rose Samba', 'Noir Anthracite', 'Blanc Pur'],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Sweat à capuche premium ultra-confort commémorant la légendaire finale de la Ligue des Champions.',
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Design néo-traditionnel bavarois célébrant la bière et la camaraderie de l\'Oktoberfest de Munich.',
    fullDescription: '• Coton 100% ringspun doux et léger (150 g/m²)\n• Encolure ras-du-cou côtelée de haute qualité\n• Impression numérique respirante idéale pour fêter activement\n• Illustration bavaroise de renommée revisitée par IA avec des touches modernes',
    price: 24.99,
    originalPrice: 34.99,
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Sweat à capuche au design fluorescent célébrant le grand frisson de la nuit d\'Halloween.',
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Une explosion de couleurs pastel et de motifs boho-chic inspirés par la brise chaleureuse du désert de Californie.',
    fullDescription: '• Coton biologique brossé extrêmement doux\n• Design de type collage artistique généré sous l\'inspiration de vagues mélodiques\n• Coupe fluide déserte décontractée avec manches à revers',
    price: 27.99,
    image: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?q=80&w=600&auto=format&fit=crop',
    gallery: ['https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?q=80&w=600&auto=format&fit=crop'],
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Casquette de baseball rétro avec broderie dynamique aux couleurs olympiques légendaires.',
    fullDescription: '• Couronne structurée à 5 panneaux à profil moyen\n• Visière pré-courbée avec dessous contrasté rétro\n• Filet arrière respirant en nid d\'abeille haute durabilité\n• Fermeture plastique snapback réglable de style classique',
    price: 19.99,
    originalPrice: 29.99,
    image: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=600&auto=format&fit=crop',
    gallery: ['https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=600&auto=format&fit=crop'],
    ...
    boughtLastMonth: 950,
    isBestSeller: true,
    tags: ['Olympics', 'Casquette', 'Sport', 'Anées 80', 'Rétro'],
    eventType: 'sport',
    category: 'accessory',
    style: 'retro'
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Mug céramique thermo-réactif révélant un feu d\'artifice doré majestueux lorsque la boisson chauffe.',
    fullDescription: '• Céramique haute intensité (325 ml)\n• Forme ergonomique confortable, anse large isolée thermiquement\n• Impression sensible à la température révélant un décompte festif magique',
    price: 14.99,
    originalPrice: 19.99,
    image: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop',
    gallery: ['https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop'],
  ...
  },
  {
    ...
    brand: 'INSTAWEAR',
    description: 'Inspiré par le crissement des pneus sur les routes de la Principauté et l\'héritage de la vitesse vintage.',
    fullDescription: '• Coupe droite classique "Boxy" rétro style années 90\n• Encolure épaisse et surpiqûres à double aiguilles\n• Graphisme de voiture de course rétro avec filtres artistiques IA de pointe',
    price: 28.99,
    originalPrice: 38.99,
    image: 'https://images.unsplash.com/photo-1503341504253-dff48121cfc8?q=80&w=600&auto=format&fit=crop',
    gallery: ['https://images.unsplash.com/photo-1503341504253-dff48121cfc8?q=80&w=600&auto=format&fit=crop'],

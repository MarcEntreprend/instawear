...
export const mapOrder = (
  ...
  shippingAddress: {
    ...
    country: row.shipping_address_country || "US",
...
export const podApi = {
  ...
  async sync(): Promise<{ settings: PodSettings; log: SyncLog }> {
    ...
    const log: SyncLog = {
      ...
      status: "success",
      message: `${result.syncedCount} produits synchronisés avec Printful.${filledSuffix}${matSuffix}`,
    ...
    try {
      await notificationApi.create({
        ...
        description: `${result.syncedCount} produit(s) synchronisé(s)${filledSuffix}${matSuffix}`,
        category: "api",
        priority: "low",
